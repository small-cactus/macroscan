...
const AnimatedAnswer = ({ text, colorScheme }) => {
  ...
  useEffect(() => {
    ...
    const animationSequence = animations.map((anim) => {
      return Animated.timing(anim, {
        toValue: 1,
        duration: 200, // Duration for each character's fade-in
...
const styles = StyleSheet.create({
  ...
  text: {
    fontSize: 14, // Adjusted font size as per original AnimatedAnswer.js
    lineHeight: 20,
